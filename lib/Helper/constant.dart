final String appName = "Shiva's Mart Driver";

// final String baseUrl = 'https://shivasmart.com/delivery_boy/app/v1/api/';
final String baseUrl = 'https://developmentalphawizz.com/shiva_mart/delivery_boy/app/v1/api/';
